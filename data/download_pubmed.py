r"""
从 PubMed 按“发表日期范围”批量检索论文，下载论文的标题/摘要/发表日期，并保存成一个 JSON 文件。
运行指令：python download_pubmed.py --output_json pubmed_data.json --start_date "2022/01/01" --end_date "2025/12/31" --num_articles 1000
"""
